  ...
  return (
    <div className={`w-full flex flex-wrap sm:flex-nowrap items-center justify-between gap-y-3 gap-x-2 sm:gap-4 ${className}`}>
      ...
      <div
        ...
        className="order-1 flex items-center gap-1.5 hover:opacity-80 px-2 py-1.5 hover:bg-gray-100/70 shrink-0 h-auto font-normal cursor-pointer select-none rounded-[6px] transition-colors"
      >
        ...
        <span className="text-[var(--Foundation-Grey-grey-300,#868686)] font-sf-pro text-[14px] font-[510] not-italic leading-normal whitespace-nowrap">
          Filter
        </span>
        {isFilterOpen && (
          <span className="inline-flex items-center justify-center text-red-500 hover:text-red-600 ml-0.5 shrink-0">

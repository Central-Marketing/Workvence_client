          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-5">
            {recommendedSellers.map((seller, idx) => (
              ...
              >
                ...
                {/* Rating */}
                <div className="flex items-center justify-center gap-1 text-[12.5px] font-semibold text-brand-green mb-5">
                  <svg className="w-3.5 h-3.5 fill-current text-brand-green" viewBox="0 0 20 20">

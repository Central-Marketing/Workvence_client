    ...
    <div className="min-h-screen bg-white text-gray-800 pb-24 font-sans">
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex items-center gap-1 overflow-x-auto scrollbar-hide py-0">
            {categories.map((cat) => (
              <Link
                key={cat}
                href={`/packages?category=${cat === 'All services' ? 'ai-services' : encodeURIComponent(cat)}`}
      ...
      <div className="container mx-auto px-4 md:px-6 pt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          {/* Card 1 */}
          <div className="bg-white border border-gray-200/90 rounded-[6px] p-6 sm:p-7 shadow-[0_2px_15px_rgba(0,0,0,0.025)]">
            <div className="w-11 h-11 rounded-[6px] bg-[#eaf8f0] text-brand-green flex items-center justify-center mb-5">

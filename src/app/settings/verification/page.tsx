...
export default function SettingsVerificationPage() {
  ...
  return (
    <div className="w-full min-h-screen bg-gray-50/70 pt-10 md:pt-16 pb-[80px] min-[1400px]:pb-[100px]">
      <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {user && !user.isSeller ? (
          <div className="bg-white rounded-[6px] border border-gray-200 shadow-sm p-8 text-center max-w-xl mx-auto">
            <div className="w-16 h-16 rounded-[6px] bg-emerald-50 border border-emerald-200 flex items-center justify-center text-brand-green mx-auto mb-4">
              <Sparkles size={32} />
            </div>
            ...
            <div className="flex justify-center gap-3">
              <Link
                ...
                className="px-6 py-2.5 bg-brand-green hover:bg-[#389115] text-white text-sm font-bold rounded-[6px] transition-all shadow-sm"
              >
                Become a Seller
              </Link>
              <Link
                href="/profile"
                className="px-5 py-2.5 border border-gray-200 text-gray-700 hover:bg-gray-50 text-sm font-semibold rounded-[6px] transition-all"
              >
                Back to Profile
              </Link>
            </div>

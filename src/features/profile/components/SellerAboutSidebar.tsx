    ...
    <div className="w-full space-y-6">
      ...
      <div className="bg-[#F5F5F5] border border-gray-200/80 rounded-2xl p-6 shadow-2xs">
        ...
        <div className="grid grid-cols-3 gap-2.5 mb-6">
          {/* Box 1: Location */}
          <div className="bg-white border border-gray-200/70 rounded-xl p-3 flex items-center gap-2.5 shadow-2xs">
            <div className="w-8 h-8 rounded-full bg-red-50 text-red-500 flex items-center justify-center shrink-0">
              <FiMapPin className="w-4 h-4" />
            </div>
            <div className="min-w-0">
              <span className="text-[11px] text-gray-400 block font-normal">From</span>
              <span className="text-xs font-bold text-gray-900 truncate block">{country}</span>
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-200/70 rounded-xl p-3 flex items-center gap-2.5 shadow-2xs">
            ...
            <div className="min-w-0">
              <span className="text-[11px] text-gray-400 block font-normal">Response Time</span>
              <span className="text-xs font-bold text-gray-900 truncate block">{responseTime}</span>
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-200/70 rounded-xl p-3 flex items-center gap-2.5 shadow-2xs">
            ...
            <div className="min-w-0">
              <span className="text-[11px] text-gray-400 block font-normal">On Time Delivery</span>
              <span className="text-xs font-bold text-gray-900 truncate block">{onTimeDelivery}</span>
            </div>
          </div>
        </div>

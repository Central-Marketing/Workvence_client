...
export const PackagesClient = ({ initialData }: PackagesClientProps) => {
  ...
  const { isLoading, isError, error, data, refetch } = useQuery({
    ...
    initialData: initialData && ((Array.isArray(initialData) && initialData.length > 0) || (Array.isArray(initialData?.gigs) && initialData.gigs.length > 0)) ? initialData : undefined,
    retry: 1
  });

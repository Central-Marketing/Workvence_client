        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
          ...
          <div className="bg-white border border-gray-100 rounded-[6px] p-7 sm:p-9 flex flex-col items-start transition-shadow duration-300 hover:shadow-md">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center h-[46px] px-8 rounded-[6px] text-sm font-semibold bg-black hover:bg-black/90 text-white transition-colors"
            >
              Browse packages
            </Link>
          </div>
